...
import AppSidebar from '@/core/layouts/PrivateAppLayout/AppSidebar'
import AppTopbar from '@/core/layouts/PrivateAppLayout/AppTopbar'
import { LayoutContext } from '@/core/layouts/PrivateAppLayout/layoutContext'
import type { AppTopbarRef, ChildContainerProps } from '@/core/layouts/PrivateAppLayout/types'
...
const Layout = (props: ChildContainerProps) => {
  ...
  const containerClassName = classNames({
    ...
    'layout-light':
      layoutConfig.layoutTheme === 'colorScheme' &&
